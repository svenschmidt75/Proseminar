...
\begin{figure}[htb]
    \begin{center}
        \input{../graphics/ErstatzSchaltbild4/document}
...
\begin{figure}[!htb]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        ...
        \label{Spirale}
    \end{subfigure}
    \caption{Links: Graph von $|\underline_{U}|$, eingeschlossen von Hüllkurven. Rechts: Projektion der hinlaufenden
    Teilwelle $\left| U_h \right|$ auf die $x/y$-Achse für festes $t$.}
\end{figure}
