...
\begin{align*}
    ...
    u(x, t) &= \mathrm{Re} \left( \underline{U}(x) \exp(\mathrm{j} \omega t) \right)
\end{align*}
...
wobei wir
\begin{equation}
    Z = \sqrt{\frac{G^{\prime} + \mathrm{j} \omega C^{\prime}}{R^{\prime} + \mathrm{j} \omega L^{\prime}}}
\end{equation}
...
Phasenkonstante (oder-belag). Für die Spannung gilt dann
\begin{align}
u(x, t) &= \mathrm{Re} \left[ \underline{U}(x) \mathrm{e}^{\mathrm{j} \omega t} \right] \\[1ex]
&= \mathrm{Re} \left[
